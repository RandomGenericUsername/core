...
class BuildContext:
    ...
    dockerfile: str | Path
    """Rendered Dockerfile content OR path to Dockerfile/Containerfile"""

    context_path: Path | None = None
    """Optional override for build context directory.
       If None and dockerfile is Path: defaults to dockerfile.parent
       If None and dockerfile is str: defaults to temporary directory"""
