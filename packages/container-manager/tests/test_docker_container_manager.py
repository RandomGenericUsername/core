...
from container_manager.core import (
    ContainerInfo,
...
from container_manager.implementations.docker import (
...
class TestDockerContainerManager:
    ...
    def test_run_basic(self, sample_run_config, mock_docker_command):
        ...
        with patch(
            "container_manager.implementations.docker.container.run_docker_command",
